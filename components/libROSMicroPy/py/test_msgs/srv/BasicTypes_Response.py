...
class BasicTypes_Response(Message):
    _TYPE_NAME = 'BasicTypes_Response'
    _TYPE_DEF = _TYPE_DEFS['BasicTypes_Response']
    _fields_and_field_types = {'bool_value': 'bool', 'byte_value': 'byte', 'char_value': 'char', 'float32_value': 'float32', 'float64_value': 'float64', 'int8_value': 'int8', 'uint8_value': 'uint8', 'int16_value': 'int16', 'uint16_value': 'uint16', 'int32_value': 'int32', 'uint32_value': 'uint32', 'int64_value': 'int64', 'uint64_value': 'uint64', 'string_value': 'string'}

    def __init__(self, bool_value=None, byte_value=None, char_value=None, float32_value=None, float64_value=None, int8_value=None, uint8_value=None, int16_value=None, uint16_value=None, int32_value=None, uint32_value=None, int64_value=None, uint64_value=None, string_value=None):
...
dataMap = BasicTypes_Response.get_data_map()
