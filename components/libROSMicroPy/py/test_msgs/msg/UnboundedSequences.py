...
class UnboundedSequences(Message):
    _TYPE_NAME = 'UnboundedSequences'
    _TYPE_DEF = _TYPE_DEFS['UnboundedSequences']
...
dataMap = UnboundedSequences.get_data_map()
