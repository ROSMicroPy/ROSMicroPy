...
class LaserScan(Message):
    _TYPE_NAME = 'LaserScan'
    _TYPE_DEF = _TYPE_DEFS['LaserScan']
    _fields_and_field_types = {'header': 'Header', 'angle_min': 'float32', 'angle_max': 'float32', 'angle_increment': 'float32', 'time_increment': 'float32', 'scan_time': 'float32', 'range_min': 'float32', 'range_max': 'float32', 'ranges': 'float32', 'intensities': 'float32'}
...
dataMap = LaserScan.get_data_map()
